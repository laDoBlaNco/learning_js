class Car{
  constructor(x,y,w,h,controlType,maxSpeed=4,color='blue'){
    this.x=x;
    this.y=y;
    this.w=w;
    this.h=h;
  ...
  draw(ctx,drawSensor=false){
    ...
    // Now with our polygon we don't need the rotate trick anymore:
    // if(this.damaged){
    //   ctx.fillStyle='gray';
    // }else{
    //   ctx.fillStyle=color;
    ...
    // So as not to lose the code I'm just commenting it out, but now we've evolved from
    // our polygon to an image we created in ppt.
