window.addEventListener('load',function(){
    ...
    // built-in Canvas 2D Api holds all the  canvas 
    // drawing methods and settings
    ...
    function drawBranch(level){
        ...
        ctx.beginPath();
        ctx.arc(0,size,size*.1,0,Math.PI*2);
        ctx.fill();
    }
...
// coordinate system on canvas uses the horizontal x
// and vertial y. x starts at 0 and goes from
// left to right. y starts at 0 on top and 
// goes down.

// Fractals are created by repeating a simple process over and over
